module.exports = nativeDescription: "français", englishDescription: "French", translation:
  ...
  play:
    ...
    confirm: "Confirmer"
    owned: "Possédés" # For items you own
    locked: "Verrouillé"
    ...
    change_hero: "Changer de Héro" # Go back from choose inventory to choose hero
    ...
    awaiting_levels_adventurer_suffix: "afin d'être le premier à jouer aux nouveaux niveaux."
    ...
    campaign_dev_description: "... dans lesquels vous apprendrez à utiliser l'interface en faisant quelque chose d'un petit peu plus complexe."
    ...
    campaign_classic_algorithms_description: "... dans lesquels vous apprendrez les algorithmes les plus populaires en l'informatique."
...
#    forgot_password: "Mot de passe oublié ?"
    authenticate_gplus: "Authentification G+"
    load_profile: "Charger profil G+"
    load_email: "Charger Email G+"
    finishing: "Finalisation"
#    sign_in_with_facebook: "S'enregistrer via Facebook"
#    sign_in_with_gplus: "S'enregistrer via G+"
#    signup_switch: "Vous préférez créer un compte?"
...
#    login_switch: "Vous possédez déjà un compte?"
  ...
  play_level:
    ...
    reload_title: "Réinitialiser tout le code?"
    reload_really: "Êtes-vous sûr de vouloir réinitialiser ce niveau et retourner au début?"
    reload_confirm: "Tout réinitialiser"
#    victory: "Victoire"
    ...
    victory_return_to_ladder: "Retourner à l'échelle" # You mean the tool or the companion ?
...
#    victory_experience_gained: "XP Remporté"
#    victory_gems_gained: "Gemmes Remportées"
    guide_title: "Guide"
    ...
    tip_think_solution: "Réfléchissez à la solution et non au problème."
    ...
    tip_error_free: "Il y a deux façons d'écrire des programmes sans erreur; seulement la troisième marche. - Alan Perlis"
...
#    tip_reticulating: "Tissage du réseau."
#    tip_harry: "Tu es un sorcier, Harry "
    tip_great_responsibility: "Avec de grandes compétences en programmation vient une grande responsabilité de débogage."
    tip_munchkin: "Si vous ne mangez pas vos légumes, un munchkin viendra vous manger pendant que vous dormirez."
    tip_binary: "Il y a seulement 10 types de personnes dans le monde: ceux qui comprennent le binaire, et ceux qui ne le comprennent pas."
...
#    unsubscribe: "Désinscription"
    levels: "Débloquez 17 niveaux supplémentaires! Et 5 nouveaux chaque semaine!"
    heroes: "Des héros plus puissants!"
    ...
    parents_blurb2: "Pour $9.99 USD/mois, il obtient de nouveaux défis chaque semaine et le support par email de programmeurs professionnels."
    parents_blurb3: "Pas de risque : garanti 100% remboursé, désinscription facile en 1-clic."
...
#    default: "Par défaut"
  ...
  skill_docs:
#    writable: "writable" # Hover over "attack" in Your Skills while playing a level to see most of this # Couldn't find it. Could be "Complétion" - complete the sentence - or "Inscrivable" - as "possible to write on smth -
    read_only: "lecture seulement"
    action_name: "nom"
#    action_cooldown: "Prend"
    action_specific_cooldown: "Cooldown" # "cooldown" is almost an anglicism in France, it's not shocking not to translate it.
    action_damage: "Dégat"
    action_range: "Portée"
    action_radius: "Rayon"
  ...
  options:
    ...
    volume_label: "Volume"
    music_label: "Musique"
    music_description: "Arrêter/Relancer la musique de fond."
    ...
    editor_config_level_language_description: "Définir le langage de programmation pour un niveau en particulier."
    editor_config_default_language_label: "Langage de Programmation par défaut"
    editor_config_default_language_description: "Choississez le langage de programmation que vous souhaitez utiliser dans les nouveaux niveaux"
  ...
  contact:
    ...
    recruitment_reminder: "Utilisez ce formulaire pour entrer en contact avec le candidat qui vous interesse. Souvenez-vous que CodeCombat facture 15% de la première année de salaire. Ces frais sont dûs à l'embauche de l'employé, ils sont remboursables pendant 90 jours si l'employé ne reste pas employé. Les employés à temps partiel, à distance ou contractuels sont gratuits en tant que stagiaires." # Deprecated
  ...
  account_settings:
    ...
    job_profile_approved: "Votre profil d'emploi a été approuvé par CodeCombat. Les employeurs seront en mesure de voir votre profil jusqu'à ce que vous le marquiez inactif ou qu'il n'ait pas été changé pendant quatre semaines."
...
#    skip_scripts: "Sauter tous les scripts auto."
    toggle_playback: "Basculer entre lecture/pause."
#    scrub_playback: "Rembobiner ou accélérer."
#    single_scrub_playback: "Rembobiner ou avancer d'une image."
#    scrub_execution: "Annuler l'exécution du sort en cours."
    toggle_debug: "Afficher la console de déboggage"
    toggle_grid: "Afficher une grille"
#    toggle_pathfinding: "Activer les indices de surlignage."
  ...
  community:
    ...
    introduction: "Découvrez les façons dont vous pouvez vous impliquer ci-dessous et décidez de ce qui semble le plus amusant. Nous sommes impatients de travailler avec vous!"
    level_editor_prefix: "Utilisez CodeCombat"
    ...
    thang_editor_prefix: "Nous appelons les unités dans le jeu 'thangs'. Utilisez les"
    thang_editor_suffix: "pour modifier l'illustration de la source de CodeCombat, permettre aux unités de lancer des projectiles, de modifier la direction de l'animation, de changer les points de vie d'une unité, ou de télécharger vos propres sprites vectoriels."
    ...
    article_editor_suffix: "et aider les joueurs de CodeCombat à tirer le meilleur parti de leur temps de jeu."
...
#    level_tab_docs: "Documentation" # Same word
    ...
    read_only_warning2: "Note: vous ne pouvez sauvegarder aucune édition, car vous n'êtes pas identifié(e)."
    no_achievements: "Aucuns succès n'ont encore été ajoutés à ce niveau."
#    achievement_query_misc: "Succès clef externe aux divers"
  ...
  contribute:
    ...
    character_classes_title: "Classes de personnage"
    introduction_desc_intro: "Nous plaçons beaucoup d'expoir en CodeCombat."
    introduction_desc_pref: "Nous voulons être l'endroit où les développeurs de tous horizons viennent pour apprendre et jouer ensemble, présenter les autres au monde du développement, et refléter le meilleur de la communauté. Nous ne pouvons et ne voulons pas faire ça seuls ; ce qui rend extra les projets comme GitHub, Stack Overflow et Linux, c'est que les gens qui les utilisent les construisent. Dans ce but, "
    introduction_desc_github_url: "CodeCombat est totalement open source"
    introduction_desc_suf: ", et nous avons pour objectif de fournir autant de moyens possibles pour que vous participiez et fassiez de ce projet autant le votre que le nôtre."
    introduction_desc_ending: "Nous espérons que vous allez rejoindre notre aventure!"
    ...
    archmage_summary: "Intéressé(e) à l'idée de travailler sur les graphismes du jeu, la conception de l'interface utilisateur, la base de données et l'organisation de serveur, réseau multijoueur, la physique, le son, ou la performance du moteur de jeu? Vous voulez aider à construire un jeu pour aider les autres à apprendre ce à quoi vous êtes bon? Nous avons beaucoup à faire et si vous êtes un programmeur/une programmeuse expérimenté(e) et souhaitez développer pour CodeCombat, cette classe est faite pour vous. Nous aimerions que vous nous apportiez votre aide pour bâtir le meilleur jeu de programmation ayant jamais existé."
    archmage_introduction: "L'un des meilleurs aspects de la création d'un jeu, c'est qu'il regroupe tant de choses différentes. Graphismes, sons, réseau en temps réel, réseaux sociaux, et bien sûr bien d'autres aspects de la programmation, de la gestion bas niveau de base de donnée, et de l'administration de serveur à l'élaboration d'interfaces utilisateur. Il y a tant à faire, et si vous êtes un programmeur/une programmeuse expérimenté(e) avec une aspiration à vraiment plonger dans le fond de CodeCombat, cette classe est faite pour vous. Nous aimerions que vous nous apportiez votre aide dans le meilleur jeu de développement de tous les temps."
    ...
    join_desc_2: "pour commencer, et cocher la case ci-dessous pour vous marquer comme un courageux archimage et obtenir les dernières nouvelles par email. Envie de discuter de ce qu'il y a à faire ou de comment être plus impliqué? "
    ...
    more_about_archmage: "En apprendre plus sur comment devenir un puissant archimage"
    ...
    artisan_introduction_pref: "Nous devons créer des niveaux additionnels! Les gens veulent plus de contenu, et nous ne pouvons pas tous les créer nous-même. Maintenant, votre station de travail est au niveau un ; notre éditeur de niveau est à peine utilisable même par ses créateurs, donc méfiez-vous. Si vous avez des idées sur la boucle for de"
    artisan_introduction_suf: ", cette classe est faite pour vous."
    artisan_attribute_1: "Une expérience dans la création de contenu comme celui-ci serait un plus, comme utiliser l'éditeur de niveau de Blizzard. Mais ce n'est pas nécessaire!"
    artisan_attribute_2: "Vous aspirez à faire beaucoup de tests et d'itérations. Pour faire de bons niveaux, vous aurez besoin de les proposer aux autres et de les regarder les jouer, puis être prêt à trouver un grand nombre de choses à corriger."
    artisan_attribute_3: "Pour l'heure, vous trvaillerez en binôme avec un Aventurier. Notre éditeur de niveaux est vraiment primaire et frustrant à l'utilisation. Vous êtes prévenus!"
    artisan_join_desc: "Etapes de création d'un niveau:"
    ...
    adventurer_join_suf: "si vous préférez être averti(e) ainsi, inscrivez-vous ici!"
    more_about_adventurer: "En apprendre plus sur comment devenir un brave Aventurier"
    adventurer_subscribe_desc: "Recevoir un email lorsqu'il y a de nouveaux niveaux à tester."
    scribe_summary_pref: "CodeCombat ne va pas juste être un tas de niveaux. Il sera également une source de connaissances de programmation auxquelles les joueurs pourront se référer. De cette façon, chaque artisan peut créer un lien vers un article détaillé pour l'édification du lecteur: documentation semblable à ce que le "
    scribe_summary_suf: " a construit. Si vous aimez expliquer les concepts de programmation, cette classe est faite pour vous."
    ...
    scribe_attribute_1: "Vos compétences rédactionnelles sont quasiment la seule chose dont vous aurez besoin. Pas seulement la grammaire et l'orthographe, il faudra également également être capable de lier des idées ensemble."
    ...
    diplomat_summary: "CodeCombat peut être très intéressant dans d'autres pays qui ne parlent pas l'anglais! Nous recherchons des traducteurs qui sont prêts à passer leur temps à traduire le corpus de mots du site pour que CodeCombat soit accessible partout dans le monde dès que possible. Si vous souhaitez aider à rendre CodeCombat international, cette classe est faite pour vous."
    diplomat_introduction_pref: "Si nous avons appris quelque chose du "
    diplomat_launch_url: "lancement en octobre"
    diplomat_introduction_suf: "c'est qu'il y a un certain intérêt pour CodeCombat dans d'autres pays, particulièrement au Brésil! Nous montons une équipe de traducteurs pour changer une liste de mots en une autre afin que CodeCombat soit le plus accessible possible à travers le monde. Si vous souhaitez avoir un aperçu des prochains contenus et avoir les niveaux dans votre langue le plus tôt possible, alors cette classe est faite pour vous."
    ...
    ambassador_introduction: "C'est la communauté que nous construisons, et vous en êtes les connexions. Nous avons des discussions via le chat Olark, les emails et les réseaux sociaux avec plusieurs personnes, et l'aide vient à la fois du jeu lui-même et grâce à lui. Si vous voulez aider les gens, prendre part à l'aventure et vous amuser, avez un bon feeling envers CodeCombat et ce vers quoi nous allons, alors cette classe est faite pour vous."
    ambassador_attribute_1: "Compétences en communication. Être capable d'identifier les problèmes que les joueurs ont et de les aider à les résoudre. Mais aussi nous tenir informés de ce que les joueurs disent, ce qu'ils aiment et n'aiment pas et d'autres choses de ce genre!"
    ambassador_join_desc: "parlez-nous un peu de vous, de ce que vous avez fait et ce que vous aimeriez faire. Nous partirons de ça!"
    ambassador_join_note_strong: "Note"
    ambassador_join_note_desc: "Une de nos priorités est de développer un jeu multijoueur où les joueurs qui ont du mal à réussir un niveau peuvent demander de l'aide à un joueur de plus haut niveau. Ce sera un bon moyen pour que les ambassadeurs fassent leur travail. Nous vous garderons informés!"
  ...
  ladder:
    ...
    code_being_simulated: "Votre nouveau code est en cours de simulation parmi les autres joueurs pour le classement. Ca va se rafraichir lorsque d'autres matchs auront lieu."
  ...
  user:
    ...
    no_achievements: "Pas de succès encore gagné."
    favorite_prefix: "Langage favori :"
    favorite_postfix: "."

  achievements:
    last_earned: "Derniers gagnés"
...
#    service: "Service"
    price: "Prix"
    gems: "Gemmes"
    status_subscribed: "Vous vous êtes inscrit(e) pour $9.99 USD/mois. Merci de votre aide !"
    status_unsubscribed_active: "Vous n'êtes pas inscrit(e) et ne serez pas facturé(e), mais votre compte est toujours actif."
  ...
  loading_error:
    ...
    unauthorized: "Vous devez être identifié(e) pour faire cela. Avez-vous désactivé les cookies ?"
...
#    thang: "Thang"
#    thangs: "Thangs" # No need to translate both
...
#    temp: "Temp"
  ...
  multiplayer:
    ...
    multiplayer_toggle: "Activer le mode multijoueur"
    ...
    multiplayer_coming_soon: "Plus de fonctionnalités multijoueur sont à venir"
    multiplayer_sign_in_leaderboard: "Connectez-vous ou créez un compte et obtenez votre position sur le classement."
